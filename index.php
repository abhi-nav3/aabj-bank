...
<div class="row w-100" >
  <div class="col">
    <div class="row" style="padding: 22px; padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/calcu.jpg" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/given.jpg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/contact.gif" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
  ...
  <h4 class="display-5">Welecome to AABJ Bank</h4>
  <p  class="lead alert alert-warning"><b>Latest Announcements:</b>
