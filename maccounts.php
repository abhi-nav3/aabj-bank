 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ">
        <a class="nav-link" href="mindex.php" style="margin-left: 205px;">All Accounts<span class="sr-only">(current)</span></a>
      </li>
...
<div class="card w-100 text-center shadowBlue">
  <div class="card-header">
    <b>All Staff Accounts</b> <button class="btn btn-outline-success btn-sm float-right" data-toggle="modal" data-target="#exampleModal">Add New Account</button>
  </div>
  <div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="POST">
          <p align="center"><b>Enter Details</b></p>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="saveAccount" class="btn btn-primary" style="margin-right: 138px">Save Account</button>
      </form>
      </div>
    </div>
  </div>
