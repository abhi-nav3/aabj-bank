...
<body style="background: linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.2)), white; background-size: 100%">
 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ">
        <a class="nav-link active" href="mindex.php" style="margin-left: 205px;">All Accounts<span class="sr-only">(current)</span></a>
      </li>
...
<div class="card w-100 text-center shadowBlue">
  <div class="card-header">
    Account profile for <b><?php echo $row['name'];echo "</b>&nbsp;<kbd>#";echo $row['accountNo'];echo "</kbd>"; ?>
  </div>
  <div class="card-body">
