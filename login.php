...
<head>
    ...
    define('bankName', 'AABJ Bank',true);
...
<body style="background: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(images/piggy.jpg);background-size: 100%"><br>
<h1 class="alert alert-transparent" style="color: white; text-align: center;"><b><?php echo bankname; ?></b></h1>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 shadowBlack" style="margin: auto;">
	<br><h4 class="text-center text-white"><b>Login as</b></h4>
